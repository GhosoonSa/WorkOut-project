...
function Weekfinal({ show, onClose, token }) {
  ...
  const next = () => {
    ...
    navigate("/Weekthird", { status: { formData } });
  };
      ...
      <Modal.Body>
        <Form onSubmit={saveProfile}>
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" type="submit" onClick={{ done, onClose }}>
              Save
            </Button>
          </Modal.Footer>
        </Form>
